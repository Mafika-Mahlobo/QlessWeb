        ...
        <div class="form-holder">
                ...
                <div class="form-content">
                    <div class="form-items">
                        <h3 style="color: red;"><span style="color: blue !important;">Welcome</span> <?= $name ?> </h3>
                        <p style="color: red;">Select an option <span style="color: blue !important;">to book appointment:</span></p>
                        <div class="main-menu-container">
                                <button style="text-align: center; font-weight: bolder !important;" id="submit" type="submit" class="menu-btns category-btns"  onclick="bookingPage('clinic');"> Public Clinics</button>

                                <button id="submit" type="submit" class="menu-btns category-btns" style="text-align: center; font-weight: bolder !important;" onclick="bookingPage('home');">Home Affairs</button>
                                
                                <button id="submit" type="submit" style="text-align: center; font-weight: bolder !important;" class="menu-btns category-btns" onclick="bookingPage('municipal');">Local Municipalitie</button>
                        </div>
